...
Image* Sexy::IMAGE_ZOMBIEJACKSONHEAD;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_ZOMBIEJACKSONHEAD = aMgr.GetImageThrow("IMAGE_ZOMBIEJACKSONHEAD");
...
static void* gResources[ResourceId::RESOURCE_ID_MAX] =
{
	...
	&IMAGE_REANIM_ZOMBIE_DANCER_OUTERARM_UPPER2,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_REANIM_ZOMBIE_DANCER_OUTERARM_UPPER2_ID: return "IMAGE_REANIM_ZOMBIE_DANCER_OUTERARM_UPPER2";
